...
/* ./.libs/lt-near_dupe_test.c - temporary wrapper executable for .libs/near_dupe_test
...
const char * LIB_PATH_VALUE   = "/home/Joe/libpostal/src/.libs:";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/usr/local/lib:/usr/local/bin:/home/Joe/libpostal/src/.libs:";
const char * TARGET_PROGRAM_NAME = "near_dupe_test"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# near_dupe_test - temporary wrapper script for .libs/near_dupe_test\n", f);
  ...
  fputs ("    echo \"near_dupe_test:near_dupe_test:$LINENO: libtool wrapper (GNU libtool) ", f);
  fputs ("2.4.7\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"near_dupe_test:near_dupe_test:$LINENO: newargv[$lt_dump_args_N]: $lt", f);
  fputs ("_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"near_dupe_test:near_dupe_test:$LINENO: newargv[0]: $progdir/$pro", f);
  fputs ("gram\" 1>&2\n", f);
  ...
  fputs ("    PATH=/usr/local/lib:/usr/local/bin:/home/Joe/libpostal/src/.libs:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/home/Joe/libpostal/src/.libs:$PATH\"\n", f);
  fputs ("\n", f);
