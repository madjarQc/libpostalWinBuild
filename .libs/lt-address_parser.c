...
/* ./.libs/lt-address_parser.c - temporary wrapper executable for .libs/address_parser
...
const char * TARGET_PROGRAM_NAME = "address_parser"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# address_parser - temporary wrapper script for .libs/address_parser\n", f);
  ...
  fputs ("    echo \"address_parser:address_parser:$LINENO: libtool wrapper (GNU libtool) ", f);
  fputs ("2.4.7\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"address_parser:address_parser:$LINENO: newargv[$lt_dump_args_N]: $lt", f);
  fputs ("_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"address_parser:address_parser:$LINENO: newargv[0]: $progdir/$pro", f);
  fputs ("gram\" 1>&2\n", f);
