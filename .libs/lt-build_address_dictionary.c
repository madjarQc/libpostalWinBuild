...
/* ./.libs/lt-build_address_dictionary.c - temporary wrapper executable for .libs/build_address_dictionary
...
const char * TARGET_PROGRAM_NAME = "build_address_dictionary"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    echo \"build_address_dictionary:build_address_dictionary:$LINENO: libtool wr", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"build_address_dictionary:build_address_dictionary:$LINENO: newargv[$", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"build_address_dictionary:build_address_dictionary:$LINENO: newar", f);
  ...
  fputs ("\n", f);
  fputs ("  program='build_address_dictionary'\n", f);
