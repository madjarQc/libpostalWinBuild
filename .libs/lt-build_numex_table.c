...
/* ./.libs/lt-build_numex_table.c - temporary wrapper executable for .libs/build_numex_table
...
const char * TARGET_PROGRAM_NAME = "build_numex_table"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# build_numex_table - temporary wrapper script for .libs/build_numex_table\n", f);
  ...
  fputs ("    echo \"build_numex_table:build_numex_table:$LINENO: libtool wrapper (GNU lib", f);
  fputs ("tool) 2.4.7\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"build_numex_table:build_numex_table:$LINENO: newargv[$lt_dump_args_N", f);
  fputs ("]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"build_numex_table:build_numex_table:$LINENO: newargv[0]: $progdi", f);
  fputs ("r/$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='build_numex_table'\n", f);
