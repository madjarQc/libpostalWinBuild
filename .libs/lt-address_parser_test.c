...
/* ./.libs/lt-address_parser_test.c - temporary wrapper executable for .libs/address_parser_test
...
const char * EXE_PATH_VALUE   = "/usr/local/lib:/usr/local/bin:";
const char * TARGET_PROGRAM_NAME = "address_parser_test"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# address_parser_test - temporary wrapper script for .libs/address_parser_test\n", f);
  ...
  fputs ("    echo \"address_parser_test:address_parser_test:$LINENO: libtool wrapper (GNU", f);
  fputs (" libtool) 2.4.7\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"address_parser_test:address_parser_test:$LINENO: newargv[$lt_dump_ar", f);
  fputs ("gs_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"address_parser_test:address_parser_test:$LINENO: newargv[0]: $pr", f);
  ...
  fputs ("\n", f);
  fputs ("  program='address_parser_test'\n", f);
