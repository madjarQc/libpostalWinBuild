...
/* ./.libs/lt-libpostal.c - temporary wrapper executable for .libs/libpostal
...
const char * TARGET_PROGRAM_NAME = "libpostal"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# libpostal - temporary wrapper script for .libs/libpostal\n", f);
  ...
  fputs ("    echo \"libpostal:libpostal:$LINENO: libtool wrapper (GNU libtool) 2.4.7\" 1>&", f);
  fputs ("2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"libpostal:libpostal:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"libpostal:libpostal:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
