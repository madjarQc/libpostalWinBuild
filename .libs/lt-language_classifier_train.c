...
/* ./.libs/lt-language_classifier_train.c - temporary wrapper executable for .libs/language_classifier_train
...
const char * TARGET_PROGRAM_NAME = "language_classifier_train"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    echo \"language_classifier_train:language_classifier_train:$LINENO: libtool ", f);
  fputs ("wrapper (GNU libtool) 2.4.7\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"language_classifier_train:language_classifier_train:$LINENO: newargv", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"language_classifier_train:language_classifier_train:$LINENO: new", f);
  ...
  fputs ("\n", f);
  fputs ("  program='language_classifier_train'\n", f);
