...
/* ./.libs/lt-address_parser_train.c - temporary wrapper executable for .libs/address_parser_train
...
const char * TARGET_PROGRAM_NAME = "address_parser_train"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    echo \"address_parser_train:address_parser_train:$LINENO: libtool wrapper (G", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"address_parser_train:address_parser_train:$LINENO: newargv[$lt_dump_", f);
  fputs ("args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"address_parser_train:address_parser_train:$LINENO: newargv[0]: $", f);
  ...
  fputs ("\n", f);
  fputs ("  program='address_parser_train'\n", f);
