...
/* ./.libs/lt-language_classifier.c - temporary wrapper executable for .libs/language_classifier
...
const char * TARGET_PROGRAM_NAME = "language_classifier"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# language_classifier - temporary wrapper script for .libs/language_classifier\n", f);
  ...
  fputs ("    echo \"language_classifier:language_classifier:$LINENO: libtool wrapper (GNU", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"language_classifier:language_classifier:$LINENO: newargv[$lt_dump_ar", f);
  fputs ("gs_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"language_classifier:language_classifier:$LINENO: newargv[0]: $pr", f);
  ...
  fputs ("\n", f);
  fputs ("  program='language_classifier'\n", f);
